...
const QUESTIONS = [
  ...
  { cat: "cloud", q: "A company wants to avoid large upfront hardware purchases and pay only for what they use. Which expenditure model does the cloud primarily support?", options: ["CapEx (Capital Expenditure)", "OpEx (Operational Expenditure)", "Fixed cost", "Deferred expenditure"], answer: 1, explain: "Cloud uses OpEx — ongoing, pay-as-you-go operational spending — rather than large upfront CapEx investments." },
  { cat: "cloud", q: "In the shared responsibility model, which item is ALWAYS the customer's responsibility regardless of service type?", options: ["Physical datacenter", "Information and data", "Physical network", "Physical hosts"], answer: 1, explain: "Data, devices, and accounts/identities are always the customer's responsibility. Physical hosts, network, and datacenter are always the provider's." },
  { cat: "cloud", q: "Which cloud service type gives the customer the MOST control over the operating system?", options: ["SaaS", "PaaS", "IaaS", "FaaS"], answer: 2, explain: "IaaS gives the most control — the customer manages the OS, runtime, and applications, while the provider manages physical infrastructure." },
  { cat: "cloud", q: "Microsoft 365 and Outlook are examples of which cloud service model?", options: ["IaaS", "PaaS", "SaaS", "DaaS"], answer: 2, explain: "These are fully managed software products you simply use — Software as a Service (SaaS)." },
  { cat: "cloud", q: "Adding more CPU and RAM to an existing virtual machine is an example of:", options: ["Horizontal scaling (scale out)", "Vertical scaling (scale up)", "Load balancing", "Geo-replication"], answer: 1, explain: "Adding power to an existing resource is vertical scaling (scaling up). Adding more instances is horizontal scaling (scaling out)." },
  { cat: "cloud", q: "Which benefit describes a system's ability to recover from failures and continue functioning?", options: ["Scalability", "Elasticity", "Reliability", "Agility"], answer: 2, explain: "Reliability is the ability to recover from failures and keep working, supported by a globally distributed design." },
  { cat: "cloud", q: "Which Azure capability extends Azure management and governance to on-premises and other clouds?", options: ["Azure Arc", "Azure Migrate", "Azure Monitor", "Azure Policy"], answer: 0, explain: "Azure Arc projects on-premises, multi-cloud, and edge resources into Azure so they can be managed centrally." },
  { cat: "cloud", q: "A startup wants to deploy a web app without managing any servers, OS patching, or runtime. Which model best fits?", options: ["IaaS", "PaaS", "On-premises", "Co-location"], answer: 1, explain: "PaaS (e.g., Azure App Service) lets developers focus on the app while the provider manages OS, runtime, and infrastructure." },
  ...
  { cat: "arch", q: "A region pair consists of two regions that are at least how far apart?", options: ["50 miles", "100 miles", "300 miles", "1000 miles"], answer: 2, explain: "Region pairs are at least 300 miles apart within the same geography for disaster recovery." },
  { cat: "arch", q: "Which compute service is serverless and runs event-driven code, billing per execution?", options: ["Azure Virtual Machines", "Azure App Service", "Azure Functions", "Azure Kubernetes Service"], answer: 2, explain: "Azure Functions is serverless — it runs code in response to events and you pay only for executions." },
  ...
  { cat: "arch", q: "Which connection type provides a private, dedicated link to Azure that does NOT use the public internet?", options: ["VPN Gateway", "VNet peering", "ExpressRoute", "Azure DNS"], answer: 2, explain: "ExpressRoute creates a private dedicated connection between on-premises and Azure, bypassing the public internet." },
  { cat: "arch", q: "A company needs to store large amounts of unstructured data such as images and video backups. Which service fits best?", options: ["Azure Files", "Azure Blob Storage", "Azure Queue Storage", "Azure Table Storage"], answer: 1, explain: "Blob storage is object storage optimized for massive amounts of unstructured data." },
  { cat: "arch", q: "Which storage redundancy option replicates data across three availability zones in the primary region?", options: ["LRS", "ZRS", "GRS", "RA-GRS"], answer: 1, explain: "ZRS (Zone-Redundant Storage) replicates synchronously across three availability zones, protecting against zone/datacenter failure." },
  { cat: "arch", q: "Which blob access tier offers the lowest storage cost for rarely accessed, long-term archival data?", options: ["Hot", "Cool", "Cold", "Archive"], answer: 3, explain: "Archive is the lowest-cost, offline tier for rarely accessed data; retrieving data requires rehydration." },
  { cat: "arch", q: "You need to transfer 80 TB of data to Azure but have limited network bandwidth. What's the best option?", options: ["AzCopy", "Azure File Sync", "Azure Data Box", "Azure Migrate"], answer: 2, explain: "Azure Data Box is a physical appliance for offline transfer of very large datasets when network transfer is impractical." },
  { cat: "arch", q: "What is the difference between authentication and authorization?", options: ["They are the same thing", "Authentication proves identity; authorization determines access rights", "Authorization proves identity; authentication determines access rights", "Both only apply to on-premises systems"], answer: 1, explain: "Authentication (AuthN) verifies who you are; authorization (AuthZ) determines what you can do. AuthN happens first." },
  { cat: "arch", q: "Which Microsoft Entra feature lets a user sign in once to access multiple applications?", options: ["Multi-Factor Authentication", "Single Sign-On (SSO)", "Conditional Access", "Resource locks"], answer: 1, explain: "Single Sign-On (SSO) allows one set of credentials to access many apps without repeated sign-ins." },
  { cat: "arch", q: "A policy requires MFA when users sign in from an unfamiliar location. Which Entra feature enforces this?", options: ["Azure Policy", "Conditional Access", "RBAC", "Resource locks"], answer: 1, explain: "Conditional Access applies access decisions based on signals like location, device, user, and risk." },
  { cat: "arch", q: "Which service should you use to create and manage a group of identical, autoscaling, load-balanced VMs?", options: ["Availability Sets", "Virtual Machine Scale Sets", "App Service", "AKS"], answer: 1, explain: "Virtual Machine Scale Sets create and manage groups of identical, load-balanced VMs that autoscale." },
  ...
  // Management & Governance
  { cat: "govern", q: "Which tool estimates the cost of Azure services BEFORE you deploy them?", options: ["Cost Management", "TCO Calculator", "Pricing Calculator", "Azure Advisor"], answer: 2, explain: "The Pricing Calculator estimates the cost of configuring and deploying Azure products before deployment." },
  { cat: "govern", q: "Which tool compares the cost of running workloads on-premises versus in Azure?", options: ["Pricing Calculator", "TCO Calculator", "Cost Management", "Azure Monitor"], answer: 1, explain: "The Total Cost of Ownership (TCO) Calculator estimates savings by comparing on-premises vs Azure costs." },
  ...
  { cat: "govern", q: "You want to grant a user permission to manage only one resource group. Which feature should you use?", options: ["Azure Policy", "Role-Based Access Control (RBAC)", "Resource locks", "Tags"], answer: 1, explain: "RBAC assigns roles scoped to a resource, resource group, subscription, or management group following least privilege." },
  { cat: "govern", q: "Which feature prevents a critical resource from being accidentally deleted?", options: ["Tags", "Resource lock (CanNotDelete)", "Azure Policy", "RBAC"], answer: 1, explain: "A CanNotDelete resource lock allows reading/modifying but blocks deletion of the resource." },
  ...
  { cat: "govern", q: "Where do you go to see whether an Azure region you use is currently experiencing an outage?", options: ["Azure Advisor", "Azure Service Health", "Cost Management", "Log Analytics"], answer: 1, explain: "Azure Service Health gives a personalized view of outages, planned maintenance, and advisories for the services/regions you use." },
  { cat: "govern", q: "Which tool within Azure Monitor lets you write and run KQL queries against collected log data?", options: ["Application Insights", "Log Analytics", "Service Health", "Azure Advisor"], answer: 1, explain: "Log Analytics is the Azure Monitor tool for editing and running KQL log queries." },
  { cat: "govern", q: "A developer wants to monitor the performance and availability of a live web application. Which tool fits best?", options: ["Application Insights", "Azure Policy", "Cost Management", "Resource locks"], answer: 0, explain: "Application Insights (part of Azure Monitor) monitors live application performance, availability, and usage." },
  { cat: "govern", q: "Which name/value metadata helps organize resources and group costs (e.g., Environment=Production)?", options: ["Resource locks", "Tags", "Policies", "Roles"], answer: 1, explain: "Tags are name/value pairs that organize resources and enable cost grouping and reporting." },
  ...
  { cat: "govern", q: "Which language simplifies authoring infrastructure as code for Azure and compiles to ARM JSON?", options: ["YAML", "Bicep", "Terraform", "JSON Schema"], answer: 1, explain: "Bicep is a domain-specific language with cleaner syntax that compiles down to ARM templates." },
  { cat: "govern", q: "Where can you find Microsoft's compliance certifications and audit reports?", options: ["Azure Advisor", "Service Trust Portal", "Cost Management", "Azure Monitor"], answer: 1, explain: "The Service Trust Portal publishes Microsoft's security, privacy, and compliance reports and certifications." },
...
/* expose globally */
window.AZ = { CATEGORIES, FLASHCARDS, QUESTIONS, PAIRS };
