...
| **Mock Tests** (`mock-tests.html`) | All 100 scenario questions transcribed from the two provided AZ-900 practice tests (Sets 1 & 2). Full timed exam, instant-feedback practice mode, and per-domain drills with scored results, explanations, and a review breakdown. |
